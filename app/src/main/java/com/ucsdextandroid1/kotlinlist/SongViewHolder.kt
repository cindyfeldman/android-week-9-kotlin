...
class SongViewHolder private constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    private val imageView:ImageView = itemView.findViewById<ImageView>(R.id.vsi_image)
    private val titleView:TextView = itemView.findViewById<TextView>(R.id.vsi_title)
